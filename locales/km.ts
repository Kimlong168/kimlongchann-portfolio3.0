export const km = {
  ...
  about: {
    title: "អំពីខ្ញុំ",
    bio: "សួស្តី! ខ្ញុំជាអ្នកអ្នកអភិវឌ្ឍន៍កម្មវិធី (Full Stack Developer) ដែលមានចំណូលចិត្តក្នុងការបង្កើតវេបសាយដែលមានភាពងាយស្រួលប្រើប្រាស់។ ខ្ញុំមានជំនាញទៅលើ JavaScript, React js, Next js, Node js, Express js និងNest js ហើយខ្ញុំចូលចិត្តធ្វើការលើទាំង frontend និង backend នៃកម្មវិធី។",
  ...
  drawer: {
    title: "ពាក្យបញ្ជាដែលអាចប្រើបាន",
    description: "ប្រើពាក្យបញ្ជានេះដើម្បីអន្តរកម្មជាមួយកម្មវិធី។",
    commands: {
      help: "បង្ហាញប្រអប់ជំនួយ",
      commands: "បង្ហាញបញ្ជីពាក្យបញ្ជា",
      exit: "ត្រឡប់ទៅប្លុក",
      goto: "ទៅកាន់ផ្នែកជាក់លាក់",
      theme: "ប្ដូរប្រភេទ Theme",
      lang: "ប្ដូរភាសា",
      customize: "បើកការកំណត់ផ្ទាល់ខ្លួន",
      congrate: "សាកមើលហូវ​​ ហេហេ!",
      reset: "កំណត់ឡើងវិញទាំងអស់",
    },
    close: "បិទ",
  },
};
